...
(function ($) {
	...
	// Change colors
	// CKEDITOR.config.colorButton_colors = 'fff,000,252525,ff585b,cdcac6,1ca9b2,f6f1ea';
	
	// Change fonts + add google font
	// CKEDITOR.config.contentsCss = 'https://fonts.googleapis.com/css?family=Lato:300,400,400i,700,700i,900,900i|Rokkitt:400,500,600,700,800';
	// CKEDITOR.config.font_names = 'Rokkitt;';
	// CKEDITOR.config.font_names = 'Lato;' + CKEDITOR.config.font_names;
	...
	KEditor.components['text'] = {
		options: {
			...
			removeButtons: 'Save,NewPage,Preview,Print,Templates,Find,Replace,SelectAll,Scayt,Form,HiddenField,ImageButton,Button,Select,Textarea,TextField,Radio,Checkbox,Outdent,Indent,Blockquote,CreateDiv,Language,HorizontalRule,Smiley,SpecialChar,PageBreak,Styles,BGColor,Maximize,About,ShowBlocks,BidiLtr,BidiRtl,Flash,Subscript,Superscript,Anchor,Iframe',
